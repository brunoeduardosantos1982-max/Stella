...
PERSONA_CARROSSEL = (
    ...
    "apontou pelo apelido, ex.: ia-google-agentes). Se for um drop, primeiro rode "
    "`uv run stella drop <apelido>` para puxar a notícia-fonte (título, url, gancho); se "
    "vier ambíguo, pergunte ao Bruno qual. Depois pesquise referência na skill notebooklm "
